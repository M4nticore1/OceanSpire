...
public static class BuildingFactory
{
    ...
    public static Building CreateBuilding(TowerBuilding prefab, TowerBuildingEntry data)
    {
        return CreateBuilding_Internal(prefab, data);
    }

    private static Building CreateBuilding_Internal(TowerBuilding prefab, TowerBuildingEntry data)
    {
